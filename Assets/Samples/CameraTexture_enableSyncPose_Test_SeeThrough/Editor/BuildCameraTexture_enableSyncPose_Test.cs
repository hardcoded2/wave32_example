...
public class BuildCameraTexture_enableSyncPose_Test : MonoBehaviour {
	...
	[UnityEditor.MenuItem("WaveVR/Build Android APK/Build wvr_unity_CameraTexture_enableSyncPose_test.apk/32+64bit")]
	static void BuildApk()
	{
		BuildApk(null, false, true, true, true);
	}

	[UnityEditor.MenuItem("WaveVR/Build Android APK/Build wvr_unity_CameraTexture_enableSyncPose_test.apk/32bit")]
	static void BuildApk32()
	{
		BuildApk("armv7", false, false);
	}

	[UnityEditor.MenuItem("WaveVR/Build Android APK/Build wvr_unity_CameraTexture_enableSyncPose_test.apk/64bit")]
	static void BuildApk64()
	{
		BuildApk("arm64", false, true, false, true);
	}

	[UnityEditor.MenuItem("WaveVR/Build Android APK/Build+Run wvr_unity_CameraTexture_enableSyncPose_test.apk/32+64bit")]
	static void BuildAndRunApk()
	{
		BuildApk(null, true, true, true, true);
	}

	[UnityEditor.MenuItem("WaveVR/Build Android APK/Build+Run wvr_unity_CameraTexture_enableSyncPose_test.apk/32bit")]
	static void BuildAndRunApk32()
	{
		BuildApk("armv7", true, false);
	}

	[UnityEditor.MenuItem("WaveVR/Build Android APK/Build+Run wvr_unity_CameraTexture_enableSyncPose_test.apk/64bit")]
	static void BuildAndRunApk64()
	{
		BuildApk("arm64", true, false, true, false, true);
	}

	[UnityEditor.MenuItem("WaveVR/Build Android APK/Build+Dev+Run wvr_unity_CameraTexture_enableSyncPose_test.apk/32+64bit")]
	static void BuildDevAndRunApk()
	{
		BuildApk(null, true, true, true, true, true);
	}

	[UnityEditor.MenuItem("WaveVR/Build Android APK/Build+Dev+Run wvr_unity_CameraTexture_enableSyncPose_test.apk/32bit")]
	static void BuildDevAndRunApk32()
	{
		BuildApk("armv7", true, true);
	}

	[UnityEditor.MenuItem("WaveVR/Build Android APK/Build+Dev+Run wvr_unity_CameraTexture_enableSyncPose_test.apk/64bit")]
	...
	{
		string[] levels = { "Assets/Samples/CameraTexture_enableSyncPose_Test_SeeThrough/Scenes/CameraTexture_enableSyncPose_Test_SeeThrough.unity" };
		BuildApkInner("CameraTexture_enableSyncPose_Test_SeeThrough.unity", "wvr_unity_CameraTexture_enableSyncPose_test.apk", destPath, run, levels, isIL2CPP, isSupport32, isSupport64);
	}
	...
	private static void BuildApkInner(string idName, string apkName, string destPath, bool run, string[] levels, bool isIL2CPP = false, bool isSupport32 = true, bool isSupport64 = false)
	{
		...
		PlayerSettings.productName = "CameraTexture_enableSyncPose_Test";
