...
public class BuildFadeOut_Test
{
	...
	[UnityEditor.MenuItem("WaveVR/Build Android APK/Build wvr_unity_fadeout_test.apk/32+64bit")]
	static void BuildApk()
	{
		BuildApk(null, false, true, true, true);
	}

	[UnityEditor.MenuItem("WaveVR/Build Android APK/Build wvr_unity_fadeout_test.apk/32bit")]
	static void BuildApk32()
	{
		BuildApk("armv7", false);
	}

	[UnityEditor.MenuItem("WaveVR/Build Android APK/Build wvr_unity_fadeout_test.apk/64bit")]
	static void BuildApk64()
	{
		BuildApk("arm64", false, true, false, true);
	}

	[UnityEditor.MenuItem("WaveVR/Build Android APK/Build+Run wvr_unity_fadeout_test.apk/32+64bit")]
	static void BuildAndRunApk()
	{
		BuildApk(null, true, true, true, true);
	}

	[UnityEditor.MenuItem("WaveVR/Build Android APK/Build+Run wvr_unity_fadeout_test.apk/32bit")]
	static void BuildAndRunApk32()
	{
		BuildApk("armv7", true);
	}

	[UnityEditor.MenuItem("WaveVR/Build Android APK/Build+Run wvr_unity_fadeout_test.apk/64bit")]
	...
	{
		string[] levels = { "Assets/Samples/FadeOut_Test/Scenes/FadeOut_Test.unity" };
		BuildApkInner("FadeOut_Test.unity", "wvr_unity_fadeout_test.apk", destPath, run, levels, isIL2CPP, isSupport32, isSupport64);
	}
	...
	private static void BuildApkInner(string idName, string apkName, string destPath, bool run, string[] levels, bool isIL2CPP = false, bool isSupport32 = true, bool isSupport64 = false)
	{
		...
		PlayerSettings.productName = "FadeOut_Test";
